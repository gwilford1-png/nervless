...
const LESSON_CONTENT = {
  ...
  2: {
    cards: [
      `<div class="rc-card rc-concept"><img class="rc-illus rc-anim" src="/phase1-amygdala.png" alt="The brain's alarm system firing at a harmless situation"><h2 class="rc-head rc-anim">Meet your amygdala</h2><p class="rc-body rc-anim">Deep in your brain sits a small almond-shaped structure — the amygdala. It is your alarm system, constantly scanning for danger.</p><p class="rc-body rc-anim">It is fast, but crude. It cannot tell <strong>&ldquo;a lion is chasing me&rdquo;</strong> from <strong>&ldquo;twenty people are watching me present.&rdquo;</strong> A crowd of evaluating faces reads as danger.</p></div>`,
